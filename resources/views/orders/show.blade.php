	...
	<div class="panel-body">
				...
				<td class="product-info">
					...
					<div >
						<span class="product-title">
							<a target="_blank" href="{{ route('products.show', [$item->product->id]) }}">{{ $item->product->title }}</a>
						</span>
		...
		<div class="order-bottom">
			<div class="order-info">
				...
				<div class="line"><div class="line-label">订单备注：</div><div class="line-value">{{ $order->remake ?: '-' }}</div></div>
				...
				<div class="line">
					...
					<div class="value">{{ \App\Models\Order::$refundStatusMap[$order->refund_status] }}</div>
				</div>
				<div class="line">
...
$(document).ready(function() {
	...
	$('#btn-wechat').click(function() {
		swal({
			// content 参数可以是一个 DOM 元素，这里我们用 jQuery 动态生产一个 img 标签， 并通过[0]的方式获取到 DOM 元素
